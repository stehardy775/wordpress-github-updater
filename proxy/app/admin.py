...
def _page(title: str, body: str, principal: str | None) -> str:
    ...
    return (
        ...
        "body{font:14px/1.5 Avenir,system-ui,sans-serif;margin:0;background:#f6f7f9;color:#111}"
        ...
        "input{padding:6px 8px;border:1px solid #c8cdd4;border-radius:6px;background:transparent;color:inherit;min-width:200px}.form button{padding:7px 12px;border:0;border-radius:6px;background:#2b6cb0;color:#fff;font-weight:600;cursor:pointer}"
